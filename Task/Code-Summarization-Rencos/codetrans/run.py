...
MODEL_CLASSES = {'t5': (T5Config, T5Model, T5Tokenizer),
...
def convert_examples_to_features(examples, tokenizer, args,stage=None):
    ...
    for example_index, example in enumerate(examples):
        ...
        target_tokens = [tokenizer.pad_token] + target_tokens + [tokenizer.eos_token]
...
def main():
    ...
    model=Seq2Seq(model=model,encoder=encoder,decoder=decoder,embedding=embedding,config=config,
                  beam_size=args.beam_size,max_length=args.max_target_length,
                  sos_id=tokenizer.pad_token_id,eos_id=tokenizer.eos_token_id)
