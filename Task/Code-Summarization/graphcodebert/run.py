...
def main():
        ...
        for epoch in range(args.num_train_epochs):
            ...
            if args.do_eval:
                ...
                if eval_loss<best_loss:
                    ...
                    torch.save(model_to_save.state_dict(), output_model_file)  
                    args.epoch_no_improve = 0
                else:
                    args.epoch_no_improve += 1
                    logger.info("  Epoch not improve: %s", args.epoch_no_improve)
                logger.info("  "+"*"*20)
    ...
    if args.do_test:
        test(args, model, tokenizer, device, epoch=-1)
