...
def convert_examples_to_features(examples, tokenizer, args,stage=None):
    ...
    for example_index, example in enumerate(examples):
        ...
        source_ids = [tokenizer.PieceToId("<s>")]+source_ids[:args.max_source_length-2]+[tokenizer.PieceToId("</s>")]
        source_mask = [1] * (len(source_ids))
        padding_length = args.max_source_length - len(source_ids)
        source_ids+=[tokenizer.PieceToId("<pad>")]*padding_length
        ...
        target_ids = [tokenizer.PieceToId("<s>")]+target_ids[:args.max_target_length-2]+[tokenizer.PieceToId("</s>")]          
        target_mask = [1] *len(target_ids)
        padding_length = args.max_target_length - len(target_ids)
        target_ids+=[tokenizer.PieceToId("<pad>")]*padding_length
        ...
        assert len(target_mask) == args.max_target_length
