...
tokenized_hyps = [x.split()[1:] for x in hypothesis]
tokenized_refs = [[x.split()[1:] for x in reference] for reference in references]
...
print('CodeBLEU score: ', code_bleu_score*100)
